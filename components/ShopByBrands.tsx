    ...
    return (
        <div className="mb-10 lg:mb-20 bg-shop_light_bg p-5 lg:p-7 rounded-md">
            <div className="flex items-center gap-5 justify-between mb-10">
                ...
                >
                    <button className={'border px-4 py-1.5 md:px-6 md:py-2 rounded-full hover:bg-shop_light_green hover:border-shop_light_green hover:text-white hoverEffect bg-shop_lighter_green text-white border-shop_light_green '}>
                        View All
                    </button>
                </Link>
            </div>
